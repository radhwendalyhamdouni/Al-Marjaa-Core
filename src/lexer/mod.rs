...
impl Lexer {
    pub fn new(input: &str) -> Self {
        ...
        let arabic_keywords = [
            ...
            ("طبع", TokenType::Print),
            ("أطبع", TokenType::Print),
            ("ادخل", TokenType::Input),
            ("دخل", TokenType::Input),
            ...
            ("دالة_صغيرة", TokenType::Lambda),
            ("غير_متزامن", TokenType::Async),
            ("انتظر", TokenType::Await),
            ("أعطِ", TokenType::Yield),
            ("اعط", TokenType::Yield),
            ...
            ("ك", TokenType::AsKeyword),
            ("تعداد", TokenType::Enum),
            ("بيانات", TokenType::Data),
            ("واجهة", TokenType::Interface),
            ("ثيم", TokenType::Theme),
            ("موجه", TokenType::Router),
            ("موجّه", TokenType::Router),
            ("مسار", TokenType::Router),
            ("حدث", TokenType::Event),
            // ONNX والذكاء الاصطناعي المتقدم
            ("أونكس", TokenType::ONNX),
            ("onnx", TokenType::ONNX),
            ...
            ("احفظ", TokenType::Save),
            ("حفظ", TokenType::Save),
            ("استدل", TokenType::Infer),
            ("استدلال", TokenType::Infer),
            ("موتر", TokenType::Tensor),
            ("شكل", TokenType::Shape),
            ("مخرج", TokenType::Output),
            ("طبقة", TokenType::Layer),
            ("كثيف", TokenType::Dense),
            ("خطي", TokenType::Dense),
            ("التفاف", TokenType::Conv),
            ("conv", TokenType::Conv),
            ("تجميع", TokenType::Pool),
            ("pool", TokenType::Pool),
            ("طبع", TokenType::Normalize),
            ("تسوية_قيم", TokenType::Normalize),
            ("إسقاط", TokenType::Dropout),
            ("اسقاط", TokenType::Dropout),
            ("تسوية", TokenType::Flatten),
            ("flatten", TokenType::Flatten),
            ("إعادة_تشكيل", TokenType::Reshape),
            ("reshape", TokenType::Reshape),
            ("تنشيط", TokenType::Activation),
            ("سوفت_ماكس", TokenType::Softmax),
            ("softmax", TokenType::Softmax),
            ("ريلو", TokenType::Relu),
            ("relu", TokenType::Relu),
            ("سيجمويد", TokenType::Sigmoid),
            ("sigmoid", TokenType::Sigmoid),
            ("دفعة", TokenType::Batch),
            ("batch", TokenType::Batch),
            ("درّب", TokenType::Train),
            ("درب", TokenType::Train),
            ("تدريب", TokenType::Train),
            ("توقع", TokenType::Predict),
            ("تنبؤ", TokenType::Predict),
            ("محسّن", TokenType::Optimizer),
            ("محقق", TokenType::Optimizer),
            ("خسارة", TokenType::Loss),
            // واجهات المستخدم المتقدمة
            // التخطيط
            ("صف", TokenType::Row),
            ("صف_أفقي", TokenType::Row),
            ("عمود", TokenType::Column),
            ("صف_عمودي", TokenType::Column),
            ("شبكة_تخطيط", TokenType::Grid),
            ...
            ("أيقونة", TokenType::Icon),
            ("ايقونة", TokenType::Icon),
            ("شارة", TokenType::Badge),
            ("صورة_شخصية", TokenType::Avatar),
            ("تلميح", TokenType::Tooltip),
            ("نافذة", TokenType::Modal),
            ("نافذة_منبثقة", TokenType::Modal),
            ...
            ("إرسال", TokenType::Submit),
            ("ارسال", TokenType::Submit),
    ...
    pub fn next_token(&mut self) -> Result<Token, String> {
        ...
        match self.current_char {
            ...
            Some('\u{064B}'..='\u{065F}' | '\u{0670}') => Ok(self.read_identifier()),
